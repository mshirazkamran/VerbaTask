...
export function AuthLayout({ children, title, subtitle }) {
 ...
 type="button"
 onClick={toggleTheme}
 className="p-2 text-ink-secondary hover:text-ink bg-canvas border border-hairline rounded-pill hover:bg-canvas transition-colors cursor-pointer"
 ...
 <div className="bg-canvas border border-hairline rounded-xl shadow-md p-6 sm:p-8 ">
 {title && (
