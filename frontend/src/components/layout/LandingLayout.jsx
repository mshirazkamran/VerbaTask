      ...
      <nav className="sticky top-0 z-50 glass-nav">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            <Link to="/#features" className="text-sm text-ink-mute hover:text-ink transition-colors">Features</Link>
            <Link to="/#how-it-works" className="text-sm text-ink-mute hover:text-ink transition-colors">How It Works</Link>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="p-2 text-ink-secondary hover:text-ink bg-canvas/60 border border-hairline rounded-pill hover:bg-canvas-soft transition-colors cursor-pointer"
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link to="/#features" className="text-sm text-ink-secondary hover:text-primary transition-colors">Features</Link></li>
                <li><Link to="/#how-it-works" className="text-sm text-ink-secondary hover:text-primary transition-colors">How it works</Link></li>
