...
export function Modal({
 ...
 onClick={onClose}
 className="fixed inset-0 bg-brand-dark/50 "
 />
 ...
 className={`relative w-full ${maxWidth} bg-canvas dark:bg-canvas text-ink border border-hairline dark:border-white rounded-xl shadow-md p-6 z-10 overflow-hidden`}
 >
