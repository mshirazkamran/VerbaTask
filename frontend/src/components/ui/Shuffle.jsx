    ...
    () => {
      ...
      const play = () => {
        ...
        const addTween = (targets, at) => {
          ...
          if (isVertical) {
            startVars.y = (i, t) => parseFloat(t.getAttribute('data-start-y') || '0');
            vars.y = (i, t) => parseFloat(t.getAttribute('data-final-y') || '0');
          } else {
            startVars.x = (i, t) => parseFloat(t.getAttribute('data-start-x') || '0');
            vars.x = (i, t) => parseFloat(t.getAttribute('data-final-x') || '0');
          }

          tl.fromTo(targets, startVars, vars, at);

          if (colorFrom && colorTo) {
            tl.fromTo(targets, { color: colorFrom }, { color: colorTo, duration, ease }, at);
          }
        };
        ...
        if (animationMode === 'evenodd') {
          ...
          strips.forEach((strip) => {
            ...
            if (isVertical) {
              startVars.y = parseFloat(strip.getAttribute('data-start-y') || '0');
              vars.y = parseFloat(strip.getAttribute('data-final-y') || '0');
            } else {
              startVars.x = parseFloat(strip.getAttribute('data-start-x') || '0');
              vars.x = parseFloat(strip.getAttribute('data-final-x') || '0');
            }
            tl.fromTo(strip, startVars, vars, d);
