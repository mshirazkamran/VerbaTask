...
export function Table({ table, onRowClick, emptyText = 'No records found', getRowClassName }) {
 ...
 return (
 <div className="w-full overflow-x-auto border border-hairline dark:border-white rounded-xl bg-canvas dark:bg-canvas shadow-card">
 <table className="w-full text-left border-collapse text-sm">
 <thead>
 {table.getHeaderGroups().map((headerGroup) => (
 <tr
 key={headerGroup.id}
 className="border-b border-hairline bg-canvas-soft dark:bg-canvas-soft "
 >
