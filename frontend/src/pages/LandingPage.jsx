...
const features = [
 ...
 <div className="bg-[#8B5CF6]/10 rounded-lg p-3 max-w-[220px]">
 ...
 span: 'lg:col-span-2',
 extra: (
 <div className="mt-4 inline-flex items-center gap-2 px-3 py-1.5 rounded-pill bg-amber-500/10 border border-amber-500">
...
function DashboardMockup() {
 ...
 {/* Browser chrome */}
 <div className="relative bg-canvas rounded-xl border border-hairline shadow-md overflow-hidden">
 ...
 <div className="h-16 rounded flex items-end">
...
export function LandingPage() {
 ...
 <motion.div
 key={feature.title}
 className={`glass-card rounded-xl p-6 border border-hairline shadow-card hover:shadow-md hover:border-primary/40 transition-all duration-300 ${feature.span}`}
 initial={{ opacity: 0, y: 24 }}
 whileInView={{ opacity: 1, y: 0 }}
