...
function StatCard({ label, value, sub, icon: Icon, loading, variant = 'primary', formatter, index = 0 }) {
  const variantStyles = {
    primary: {
      card: 'bg-indigo-50/70 dark:bg-indigo-950/30 backdrop-blur-md border-indigo-200/80 dark:border-indigo-800/50',
      label: 'text-indigo-700 dark:text-indigo-300 font-medium',
      value: 'text-indigo-950 dark:text-indigo-50 font-light',
      sub: 'text-indigo-600/80 dark:text-indigo-300/70',
      iconBox: 'bg-indigo-100/90 dark:bg-indigo-900/50 text-indigo-700 dark:text-indigo-300 border border-indigo-200/80 dark:border-indigo-700/50 backdrop-blur-xs',
    },
    success: {
      card: 'bg-emerald-50/70 dark:bg-emerald-950/30 backdrop-blur-md border-emerald-200/80 dark:border-emerald-800/50',
      label: 'text-emerald-700 dark:text-emerald-300 font-medium',
      value: 'text-emerald-950 dark:text-emerald-50 font-light',
      sub: 'text-emerald-600/80 dark:text-emerald-300/70',
      iconBox: 'bg-emerald-100/90 dark:bg-emerald-900/50 text-emerald-700 dark:text-emerald-300 border border-emerald-200/80 dark:border-emerald-700/50 backdrop-blur-xs',
    },
    warning: {
      card: 'bg-amber-50/70 dark:bg-amber-950/30 backdrop-blur-md border-amber-200/80 dark:border-amber-800/50',
      ...
      iconBox: 'bg-amber-100/90 dark:bg-amber-900/50 text-amber-800 dark:text-amber-300 border border-amber-200/80 dark:border-amber-700/50 backdrop-blur-xs',
    },
    danger: {
      card: 'bg-rose-50/70 dark:bg-rose-950/30 backdrop-blur-md border-rose-200/80 dark:border-rose-800/50',
      label: 'text-rose-800 dark:text-rose-300 font-medium',
      value: 'text-rose-950 dark:text-rose-50 font-light',
      sub: 'text-rose-700/80 dark:text-rose-300/70',
      iconBox: 'bg-rose-100/90 dark:bg-rose-900/50 text-rose-800 dark:text-rose-300 border border-rose-200/80 dark:border-rose-700/50 backdrop-blur-xs',
    },
  };
  ...
  return (
    ...
    >
      <div className={`relative rounded-xl border ${config.card} p-5 shadow-card transition-all duration-200 hover:shadow-float`}>
...
function CustomChartTooltip({ active, payload, label }) {
  if (active && payload && payload.length) {
    return (
      <div className="bg-canvas/90 dark:bg-canvas/80 backdrop-blur-md border border-hairline/80 dark:border-white/10 p-3 rounded-lg shadow-float text-xs">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card padding="none" className="lg:col-span-2 overflow-hidden flex flex-col border border-indigo-200/80 dark:border-indigo-800/50">
          <div className="px-5 py-3.5 border-b border-hairline/80 flex items-center justify-between bg-canvas/60 dark:bg-canvas/40 backdrop-blur-xs">
            <div className="flex items-center gap-2">
              <div className="w-7 h-7 rounded-md bg-indigo-50 dark:bg-indigo-950/50 text-indigo-700 dark:text-indigo-300 border border-indigo-200 dark:border-indigo-800/60 flex items-center justify-center">
                <IconChartBar className="w-4 h-4" />
              </div>
              <h3 className="text-sm font-medium text-ink">Revenue Activity</h3>
            </div>
            <span className="text-xs font-medium px-2 py-0.5 rounded-md bg-indigo-50/80 dark:bg-indigo-950/50 backdrop-blur-xs border border-indigo-200 dark:border-indigo-800/60 text-indigo-700 dark:text-indigo-300 font-tabular">
              7-Day Trend
            </span>
          </div>
        ...
        <Card padding="none" className="overflow-hidden flex flex-col border border-hairline">
          <div className="px-5 py-3.5 border-b border-hairline/80 flex items-center justify-between bg-canvas/60 dark:bg-canvas/40 backdrop-blur-xs">
            <div className="flex items-center gap-2">
              <div className="w-7 h-7 rounded-md bg-emerald-50 dark:bg-emerald-950/50 text-emerald-700 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800/60 flex items-center justify-center">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        <Card padding="none" className="xl:col-span-2 overflow-hidden border border-hairline">
          <div className="px-5 py-4 border-b border-hairline flex items-center justify-between">
            ...
            {stats?.activeWorkflows != null && (
              <div className="flex items-center gap-1.5 text-xs px-2.5 py-1 rounded-md bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800/60 text-amber-800 dark:text-amber-300 font-medium">
        ...
        <Card padding="none" className="overflow-hidden border border-hairline">
          <div className="px-5 py-4 border-b border-hairline flex items-center justify-between">
            <div className="flex items-center gap-2">
              <div className="w-7 h-7 rounded-md bg-amber-50 dark:bg-amber-950/50 text-amber-700 dark:text-amber-300 border border-amber-200 dark:border-amber-800/60 flex items-center justify-center">
